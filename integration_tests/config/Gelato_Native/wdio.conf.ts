...
import exceptionConstants from './../../src/exceptions/exceptionConstants';
...
const config = {
    ...
    //
    specs: [
        './test/features/Gelato_Native/test.feature',
    ],
    // Patterns to exclude.
    exclude: [
    ...
    cucumberOpts: {
        ...
        profile: [],
        require: [
            './src/stepDefinitions/Gelato_Native/*.ts',
        ],
